...
void CnnKernel(__global const float* input, __global const float* weight,
  ...
  float res00_08, res01_08, res10_08, res11_08;
  res00_08 = res01_08 = res10_08 = res11_08 = bias[layer];

  float res00_09, res01_09, res10_09, res11_09;
  res00_09 = res01_09 = res10_09 = res11_09 = bias[layer];
  ...
  int y_position_8 = ((pixel_y + 8) * 2);
  int y_position_9 = ((pixel_y + 9) * 2);
  int y_position_10 = ((pixel_y + 10) * 2); 
  int y_position_11 = ((pixel_y + 11) * 2); 
  int y_position_12 = ((pixel_y + 12) * 2);
  int y_position_13 = ((pixel_y + 13) * 2);
  int y_position_14 = ((pixel_y + 14) * 2); 
  int y_position_15 = ((pixel_y + 15) * 2);   

  __local local_input[64][8][20];
  int num_layers_per = 256/get_local_size(0);

  for (int i = 0; i < 4; i++){
    for (int j = 0; j < 64; j += num_layers_per){
      for (int p = 0; p < 8; p++){
        for (int q = q; q < 20; q++)
      }
    }
    for (int j = 0; j < kNum; ++j) {
      for (int p = 0; p < 5; ++p) {
        for (int q = 0; q < 5; ++q) {
          ...
          res00_08 += curr_weight *
                      input[x_position_0 + p * kInImSize + y_position_8 + q];
          res10_08 += curr_weight *
                      input[x_position_0 + (1 + p) * kInImSize + y_position_8 + q];
          res01_08 += curr_weight *
                      input[x_position_0 + p * kInImSize + y_position_8 + 1 + q];
          res11_08 += curr_weight *
                      input[x_position_0 + (1 + p) * kInImSize + y_position_8 + 1 + q];

          res00_09 += curr_weight *
                      input[x_position_0 + p * kInImSize + y_position_9 + q];
          res10_09 += curr_weight *
                      input[x_position_0 + (1 + p) * kInImSize + y_position_9 + q];
          res01_09 += curr_weight *
                      input[x_position_0 + p * kInImSize + y_position_9 + 1 + q];
          res11_09 += curr_weight *
                      input[x_position_0 + (1 + p) * kInImSize + y_position_9 + 1 + q];

          res00_10 += curr_weight *
                      input[x_position_0 + p * kInImSize + y_position_10 + q];
          res10_10 += curr_weight *
                      input[x_position_0 + (1 + p) * kInImSize + y_position_10 + q];
          res01_10 += curr_weight *
                      input[x_position_0 + p * kInImSize + y_position_10 + 1 + q];
          res11_10 += curr_weight *
                      input[x_position_0 + (1 + p) * kInImSize + y_position_10 + 1 + q];

          res00_11 += curr_weight *
                      input[x_position_0 + p * kInImSize + y_position_11 + q];
          res10_11 += curr_weight *
                      input[x_position_0 + (1 + p) * kInImSize + y_position_11 + q];
          res01_11 += curr_weight *
                      input[x_position_0 + p * kInImSize + y_position_11 + 1 + q];
          res11_11 += curr_weight *
                      input[x_position_0 + (1 + p) * kInImSize + y_position_11 + 1 + q];

          res00_12 += curr_weight *
                      input[x_position_0 + p * kInImSize + y_position_12 + q];
          res10_12 += curr_weight *
                      input[x_position_0 + (1 + p) * kInImSize + y_position_12 + q];
          res01_12 += curr_weight *
                      input[x_position_0 + p * kInImSize + y_position_12 + 1 + q];
          res11_12 += curr_weight *
                      input[x_position_0 + (1 + p) * kInImSize + y_position_12 + 1 + q];

          res00_13 += curr_weight *
                      input[x_position_0 + p * kInImSize + y_position_13 + q];
          res10_13 += curr_weight *
                      input[x_position_0 + (1 + p) * kInImSize + y_position_13 + q];
          res01_13 += curr_weight *
                      input[x_position_0 + p * kInImSize + y_position_13 + 1 + q];
          res11_13 += curr_weight *
                      input[x_position_0 + (1 + p) * kInImSize + y_position_13 + 1 + q];

          res00_14 += curr_weight *
                      input[x_position_0 + p * kInImSize + y_position_14 + q];
          res10_14 += curr_weight *
                      input[x_position_0 + (1 + p) * kInImSize + y_position_14 + q];
          res01_14 += curr_weight *
                      input[x_position_0 + p * kInImSize + y_position_14 + 1 + q];
          res11_14 += curr_weight *
                      input[x_position_0 + (1 + p) * kInImSize + y_position_14 + 1 + q];

          res00_15 += curr_weight *
                      input[x_position_0 + p * kInImSize + y_position_15 + q];
          res10_15 += curr_weight *
                      input[x_position_0 + (1 + p) * kInImSize + y_position_15 + q];
          res01_15 += curr_weight *
                      input[x_position_0 + p * kInImSize + y_position_15 + 1 + q];
          res11_15 += curr_weight *
                      input[x_position_0 + (1 + p) * kInImSize + y_position_15 + 1 + q];
        }
      }
